...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posts.video'
        db.add_column(u'temas_posts', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Videos'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posts.video'
        db.delete_column(u'temas_posts', 'video_id')
