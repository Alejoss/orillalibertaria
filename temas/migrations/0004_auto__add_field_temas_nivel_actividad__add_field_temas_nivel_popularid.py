...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Temas.nivel_actividad'
        db.add_column(u'temas_temas', 'nivel_actividad',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Temas.nivel_popularidad'
        db.add_column(u'temas_temas', 'nivel_popularidad',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Temas.nivel_actividad'
        db.delete_column(u'temas_temas', 'nivel_actividad')

        # Deleting field 'Temas.nivel_popularidad'
        db.delete_column(u'temas_temas', 'nivel_popularidad')
