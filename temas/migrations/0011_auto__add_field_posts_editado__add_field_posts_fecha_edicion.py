...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posts.editado'
        db.add_column(u'temas_posts', 'editado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Posts.fecha_edicion'
        db.add_column(u'temas_posts', 'fecha_edicion',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posts.editado'
        db.delete_column(u'temas_posts', 'editado')

        # Deleting field 'Posts.fecha_edicion'
        db.delete_column(u'temas_posts', 'fecha_edicion')
