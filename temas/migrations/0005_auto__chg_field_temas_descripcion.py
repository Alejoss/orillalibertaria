...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Temas.descripcion'
        db.alter_column(u'temas_temas', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Temas.descripcion'
        db.alter_column(u'temas_temas', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
