...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posts.creador'
        db.add_column(u'temas_posts', 'creador',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['perfiles.Perfiles'], null=True),
                      keep_default=False)

        # Adding field 'Posts.tema'
        db.add_column(u'temas_posts', 'tema',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['temas.Temas'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posts.creador'
        db.delete_column(u'temas_posts', 'creador_id')

        # Deleting field 'Posts.tema'
        db.delete_column(u'temas_posts', 'tema_id')
