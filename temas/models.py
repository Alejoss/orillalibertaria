...
class Posts(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.votos_total = int(self.votos_positivos) - \
            int(self.votos_negativos)
...
class Respuestas(models.Model):
    post_respuesta = models.ForeignKey(
        Posts, related_name="respuesta", null=True)
    post_padre = models.ForeignKey(
        Posts, related_name="post_original", null=True)
...
class Votos(models.Model):
    fecha = models.DateTimeField(auto_now_add=True)
    usuario_votado = models.ForeignKey(
        Perfiles, related_name='votado', null=True)
    usuario_votante = models.ForeignKey(
        Perfiles, related_name='votante', null=True)
...
class Mensajes(models.Model):
    ...
    usuario_envia = models.ForeignKey(
        Perfiles, related_name='envia', null=True)
    usuario_recibe = models.ForeignKey(
        Perfiles, related_name='recibe', null=True)
