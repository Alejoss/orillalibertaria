...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cita.texto'
        db.alter_column(u'citas_cita', 'texto', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Cita.texto'
        db.alter_column(u'citas_cita', 'texto', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
