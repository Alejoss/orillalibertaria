...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cita.removidatotalmente'
        db.add_column(u'citas_cita', 'removidatotalmente',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cita.removidatotalmente'
        db.delete_column(u'citas_cita', 'removidatotalmente')
