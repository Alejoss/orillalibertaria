...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cdenunciadas.eliminado'
        db.add_column(u'citas_cdenunciadas', 'eliminado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cdenunciadas.eliminado'
        db.delete_column(u'citas_cdenunciadas', 'eliminado')
