...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cita.x_recibidas'
        db.add_column(u'citas_cita', 'x_recibidas',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Ceditadas.razon'
        db.alter_column(u'citas_ceditadas', 'razon', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):
        # Deleting field 'Cita.vistos_recibidos'
        db.delete_column(u'citas_cita', 'vistos_recibidos')

        # Deleting field 'Cita.x_recibidas'
        db.delete_column(u'citas_cita', 'x_recibidas')


        # User chose to not deal with backwards NULL issues for 'Ceditadas.razon'
        raise RuntimeError("Cannot reverse this migration. 'Ceditadas.razon' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Ceditadas.razon'
        db.alter_column(u'citas_ceditadas', 'razon', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        ...
        u'citas.cita': {
            ...
            'vistos_recibidos': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'x_recibidas': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
