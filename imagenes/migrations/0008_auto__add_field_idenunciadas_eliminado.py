...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idenunciadas.eliminado'
        db.add_column(u'imagenes_idenunciadas', 'eliminado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idenunciadas.eliminado'
        db.delete_column(u'imagenes_idenunciadas', 'eliminado')
