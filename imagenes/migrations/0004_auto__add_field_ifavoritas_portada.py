...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ifavoritas.portada'
        db.add_column(u'imagenes_ifavoritas', 'portada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ifavoritas.portada'
        db.delete_column(u'imagenes_ifavoritas', 'portada')
