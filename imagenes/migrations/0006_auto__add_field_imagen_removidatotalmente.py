...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Imagen.removidatotalmente'
        db.add_column(u'imagenes_imagen', 'removidatotalmente',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Imagen.removidatotalmente'
        db.delete_column(u'imagenes_imagen', 'removidatotalmente')
