...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Imagen.vistos_recibidos'
        db.add_column(u'imagenes_imagen', 'vistos_recibidos',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Imagen.xrecibidas'
        db.add_column(u'imagenes_imagen', 'xrecibidas',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Imagen.vistos_recibidos'
        db.delete_column(u'imagenes_imagen', 'vistos_recibidos')

        # Deleting field 'Imagen.xrecibidas'
        db.delete_column(u'imagenes_imagen', 'xrecibidas')
    ...
    models = {
        ...
        u'imagenes.imagen': {
            ...
            'xrecibidas': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
        u'perfiles.perfiles': {
