...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Imagen.url'
        db.alter_column(u'imagenes_imagen', 'url', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Imagen.url'
        db.alter_column(u'imagenes_imagen', 'url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
