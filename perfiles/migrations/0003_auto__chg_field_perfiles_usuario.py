...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Perfiles.usuario'
        db.alter_column(u'perfiles_perfiles', 'usuario_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Perfiles.usuario'
        db.alter_column(u'perfiles_perfiles', 'usuario_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True))
