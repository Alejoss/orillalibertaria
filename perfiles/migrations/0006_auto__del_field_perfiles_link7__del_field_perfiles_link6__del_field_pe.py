...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Perfiles.link7'
        db.delete_column(u'perfiles_perfiles', 'link7')

        # Deleting field 'Perfiles.link6'
        db.delete_column(u'perfiles_perfiles', 'link6')

        # Deleting field 'Perfiles.link9'
        db.delete_column(u'perfiles_perfiles', 'link9')

        # Deleting field 'Perfiles.link8'
        db.delete_column(u'perfiles_perfiles', 'link8')

        # Deleting field 'Perfiles.slug'
        db.delete_column(u'perfiles_perfiles', 'slug')

        # Deleting field 'Perfiles.link10'
        db.delete_column(u'perfiles_perfiles', 'link10')


    def backwards(self, orm):
        # Adding field 'Perfiles.link7'
        db.add_column(u'perfiles_perfiles', 'link7',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfiles.link6'
        db.add_column(u'perfiles_perfiles', 'link6',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfiles.link9'
        db.add_column(u'perfiles_perfiles', 'link9',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfiles.link8'
        db.add_column(u'perfiles_perfiles', 'link8',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Perfiles.link10'
        db.add_column(u'perfiles_perfiles', 'link10',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
