...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Perfiles.votos_recibidos'
        db.alter_column(u'perfiles_perfiles', 'votos_recibidos', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Perfiles.numero_de_posts'
        db.alter_column(u'perfiles_perfiles', 'numero_de_posts', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Perfiles.votos_recibidos'
        db.alter_column(u'perfiles_perfiles', 'votos_recibidos', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Perfiles.numero_de_posts'
        db.alter_column(u'perfiles_perfiles', 'numero_de_posts', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
