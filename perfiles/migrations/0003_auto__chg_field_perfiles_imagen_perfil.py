...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Perfiles.imagen_perfil'
        db.alter_column(u'perfiles_perfiles', 'imagen_perfil', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Perfiles.imagen_perfil'
        db.alter_column(u'perfiles_perfiles', 'imagen_perfil', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))
